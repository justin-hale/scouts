...
import { compareEvents, formatDateLong, formatTimeRange } from "../utils/dates";

/**
 * Renders a flat list of events grouped by day. The caller decides which
 * events to pass (e.g. "upcoming" for the agenda, "this month" under the month
 * grid); this component just sorts, groups, and renders them.
 */
